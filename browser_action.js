(function() {
  ...
  jQuery(function($) {
    var bookmarkBehaviors, buildBookmark, buildDirectory, buildIcon, buildNode, closeDirectory, directoryBehaviors, openDirectory, openingDirectory, tmpl, tree, treeData, urlBar;
    urlBar = $('#url');
    tree = $('#tree');
    treeData = {};
    tmpl = {
